...
export function useLanguage() {
  ...
  return [language, languageStore.set] as const;
}

export function themeName(theme: Theme, language: Language): string {
  return language === "fr" ? (theme.nameFr ?? theme.name) : theme.name;
}

export function cardText(card: Flashcard, language: Language) {
  return language === "fr"
