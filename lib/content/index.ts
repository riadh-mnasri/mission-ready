...
const THEME_SEEDS: ThemeSeed[] = [
  ...
  { id: "archi-hexagonale", name: "Hexagonal Architecture", color: "#6366f1", questions: archiHexagonale },
  ...
  { id: "risque-contrepartie", name: "Counterparty Risk", color: "#eab308", questions: risqueContrepartie },
  { id: "ia", name: "AI (Copilot, Claude...)", color: "#d946ef", questions: ia },
];
